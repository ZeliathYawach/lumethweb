      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <Link to="/business" className="bg-purple-900/30 p-6 rounded-xl border border-purple-500/20 hover:border-amber-400/20 transition-all duration-300">
            ...
            <Link to="/blog" className="bg-purple-900/30 p-6 rounded-xl border border-purple-500/20 hover:border-amber-400/20 transition-all duration-300">
            ...
            <Link to="/privacy-policy" className="bg-purple-900/30 p-6 rounded-xl border border-purple-500/20 hover:border-amber-400/20 transition-all duration-300">
